...
--    ADD보다 MODIFY 절이 더 많이 사용된다.
--    ALTER TABLE 테이블명
--    MODIFY 컬럼명 데이터타입 NOT NULL;

-- 4. 기존 테이블에 데이터가 이미 들어있지 않은 컬럼(NULL인 상태의 컬럼)을
--    NOT NULL 제약조건을 갖게끔 수정하는 경우에는 에러가 발생한다. (불가능)
...
INSERT INTO TBL_TEST11(COL1) VALUES(3);                 -- 에러 발생 : ORA-01400: cannot insert NULL into ("HR"."TBL_TEST11"."COL2")
INSERT INTO TBL_TEST11(COL1, COL2) VALUES(3, NULL);     -- 에러 발생 : ORA-01400: cannot insert NULL into ("HR"."TBL_TEST11"."COL2")
...
/*
HR	SYS_C007087	TBL_TEST11	C	COL2	"COL2" IS NOT NULL	
HR	SYS_C007088	TBL_TEST11	P	COL1		
*/
...
--------------------------------------------------------------------------------
-- ▼ 왜 NOT NULL 제약조건은 컬럼 레벨의 형식을 취하는 것이 좋은가?
...
HR	TEST13_COL1_PK	TBL_TEST13	P	COL1		
HR	TEST13_COL2_NN	TBL_TEST13	C	COL2	COL2 IS NOT NULL	
HR	SYS_C007093	    TBL_TEST13	C	COL2	"COL2" IS NOT NULL	
*/
...
-- ▷ SID를 자동 증가 값으로 운영하려면 시퀸스 객체가 필요하다.
...
INSERT INTO TBL_BBS(SID, NAME, CONTENTS, WRITEDAY, COUNTS, COMMENTS)
VALUES(SEQ_BBS.NEXTVAL, '한은영', '무진장 실습중입니다.', DEFAULT, 0, 0);
...
2	최동현	계속 실습중입니다.	2022-08-29 11:02:38	0	0
3	조현하	열심히 실습중입니다.	2022-08-29 11:03:20	0	0
4	한은영	무진장 실습중입니다.	2022-08-29 11:07:01	0	0
5	정미경	마무리 중입니다.	2022-08-29 11:07:30	0	0
*/
...
TBL_BBS	WRITEDAY	DATE			7			Y	4	35	"SYSDATE"						NO	NO		0		NO	YES	NONE
TBL_BBS	COUNTS	    NUMBER			22			Y	5	35	"0"								NO	NO		0		NO	YES	NONE
TBL_BBS	COMMENTS	NUMBER			22			Y	6	39	"0"								NO	NO		0		NO	YES	NONE
*/
